...
class ProductController extends Controller {
    ...
    public function store(ProductRequest $request) {
        ...
        $keys = ['name', 'branding_id', 'category_id', 'quantity', 'price', 'time', 'production', 'madein', 'madeof', 'weight', 'volume', 'description', 'content', 'brand_id'];
        ...
        return redirect()->intended('20s-admin/brand-detail?id=' . $input['brand_id']);
    ...
    public function update(ProductRequest $request, $id) {
        ...
        return redirect()->intended('20s-admin/brand-detail?id=' . $product->brand_id);
    }
